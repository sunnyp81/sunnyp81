...
The primary focus of the image. Deep nesting isolates attributes and prevents attribute bleeding.
...
"subject": {
  ...
  "face_consistency": {
    ...
    "preservation_level": "strict | flexible",
    "instruction": "maintain exact facial structure and identity",
    "allow_changes": ["expression", "lighting", "angle"]
  },
  "physicality": {
...
**Key techniques:**
- **Skin texture**: Request "visible pores, micro-wrinkles" to avoid plastic/airbrushed look
- **Material properties**: Trigger physics engine with "high gloss", "matte", "reflective"
- **Text content**: Place inside the garment block to localize text rendering
...
**Key techniques:**
- **Element arrays**: Use `[]` for distinct enumeration of background components
- **State definitions**: Define object states ("glowing", "wet") for lighting interactions

### Spatial Elements Array Example
...
Virtual camera and lighting setup. Nano Banana Pro has absorbed real-world photography specs.

```json
"cinematography": {
  "camera_body": "camera model name",
  "lens": "lens specification",
  "era_style": "early-2000s digital | 1990s film | polaroid | modern",
  "settings": {
  ...
  "lighting": {
    ...
    "key_light": {
      "type": "soft | hard | diffused | spotlight",
      "direction": "from left | from right | frontal | backlit",
      "color_temperature": "2700K warm to 6500K cool",
      "focus": "broad | narrow beam | center of face only",
      "falloff": "low | medium | high"
    },
    "fill_light": {
    ...
    "shadow_quality": "soft | sharp, dramatic edges"
  },
  "post_processing": {
...
**Key techniques:**
- **Hardware specificity**: "Arri Alexa" = high dynamic range, soft highlights. "GoPro" = high contrast, wide-angle
- **Lens physics**: "Anamorphic" triggers oval bokeh and horizontal lens flares
- **Light directionality**: "from left", "backlight" uses 3D spatial understanding
