...
## Example: Full Token Generation

**Input:** `tokens.json`
```json
{
  "primitive": {
    "color": { "blue-600": "#2563EB", "gray-50": "#F9FAFB", "gray-900": "#111827" },
...
All reference files are in this skill's `references/` directory. If a file is missing, the token architecture concepts above are self-contained enough to proceed without it.
